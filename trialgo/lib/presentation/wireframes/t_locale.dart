...
class TLocale extends InheritedWidget {
  ...
  static const Map<String, String> _fr = {
    ...
    'forgot.desc': 'Entrez votre email, nous vous enverrons un lien pour le réinitialiser.',
    'forgot.send': 'Envoyer le lien',
    'forgot.sent_title': 'Email envoyé',
    'forgot.sent_desc': 'Consultez votre boîte mail et cliquez sur le lien pour choisir un nouveau mot de passe.',
    ...
    'onb.next': 'Suivant',
    'onb.start': 'Commencer',
    'onb.1_title': 'Bienvenue sur MIXALGO',
    'onb.1_body': 'Le jeu d\'observation ou chaque carte compte. Prouve ta logique.',
    'onb.2_title': 'Le trio magique',
    'onb.2_body': 'Émettrice + Cable = Réceptrice. Trouve la carte manquante pour gagner.',
    'onb.3_title': 'Observe et deduis',
    'onb.3_body': 'Tap une carte pour répondre. Double-tap pour la voir en grand.',
    'onb.4_title': 'Prêt à jouer ?',
    'onb.4_body': 'Gagne des points, debloque de nouveaux niveaux. L\'aventure commence.',

    // --- Game ---
    'game.question': 'Quelle image complète ce trio ?',
    ...
    'game.no_lives_snack': 'Plus de vies ! Attends ou échange des étoiles.',

    // --- Results ---
    'result.success': 'Niveau réussi !',
    'result.failed': 'Niveau échoué',
    'result.congrats': 'Bravo ! Continuez votre progression.',
    'result.retry_msg': 'Courage, réessayez !',
    'result.score': 'Score',
    ...
    'help.q1': 'C\'est quoi MIXALGO ?',
    'help.a1': 'MIXALGO est un jeu de cartes base sur les transformations visuelles. Vous devez trouver l\'image manquante dans un trio E + C = R.',
    'help.q2': 'Qu\'est-ce qu\'une Émettrice ?',
    'help.a2': 'L\'Émettrice (E) est l\'image de base, le point de depart d\'un trio. Exemple : un dessin de lion.',
    'help.q3': 'Qu\'est-ce qu\'un Cable ?',
    'help.a3': 'Le Cable (C) est une IMAGE-ALGORITHME. Le dessin lui-même represente la transformation à appliquer (miroir, rotation, couleur...).',
    'help.q4': 'Comment fonctionnent les vies ?',
    'help.a4': 'Vous avez 5 vies maximum. Chaque mauvaise réponse peut en couter une. Les vies se rechargent automatiquement toutes les 30 minutes.',
    'help.q5': 'Comment gagner des points ?',
    'help.a5': 'Points = base x distance x bonus temps. Plus vous repondez vite, plus vous gagnez. Enchainez les bonnes réponses pour des bonus de série !',
    'help.q6': 'Comment activer mon jeu ?',
    'help.a6': 'Entrez le code de 16 caractères qui se trouve dans votre boîte de jeu MIXALGO. Le code est lié à un seul appareil.',
    'help.q7': 'Comment progresser dans les niveaux ?',
    'help.a7': 'Reussissez le seuil de bonnes réponses pour débloquer le niveau suivant. Les niveaux avances utilisent des distances plus grandes (D2, D3) et des configurations plus difficiles.',
    ...
    'settings.section_info': 'INFOS ET AIDÉ',
    ...
    'settings.sign_out_confirm_body': 'Tu pourras te reconnecter à tout moment avec ton email.',

    // --- Home (refonte) ---
    'home.play_button': 'JOUER',
    'home.discover': 'DECOUVRE',
    'home.last_game_section': 'DERNIÈRE PARTIE',
    'home.stat_level': 'Niveau',
    'home.stat_points': 'Points',
    'home.stat_cards': 'Cartes',
    'home.stat_stars': 'Étoiles',
    'home.stat_lives': 'Vies',
    'home.exchange_title': 'Échanger des étoiles',
    'home.exchange_ratio': '10 étoiles = 1 vie',
    'home.exchange_cta': 'Échanger',
    'home.exchange_cancel': 'Annuler',
    'home.exchange_err_stars': "Pas assez d'étoiles pour échanger.",
    'home.exchange_err_lives_max': 'Tu as déjà le maximum de vies.',
    'home.exchange_err_no_game': 'Aucun jeu actif sélectionné.',
    'home.exchange_err_network': 'Erreur réseau. Reessaie.',
    'home.exchange_err_unknown': "Échange impossible pour l'instant.",
    'home.streak_day': 'jour',
    'home.streak_days': 'jours',
    'home.streak_start': 'Commence ta série !',
    'home.no_streak': 'Pas de série',
    ...
    'home.card_collective_sub': 'Vérifier trio',
    ...
    'auth.welcome_new_hero': 'Bienvenue chez MIXALGO !',
    'auth.welcome_back_sub': 'Connecté-toi pour continuer ta partie.',
    ...
    'auth.password_hint_signup': 'Minimum 6 caractères',
    ...
    'auth.cta_signup': 'CRÉER MON COMPTE',
    'auth.strength_weak': 'Faible',
    'auth.strength_medium': 'Moyen',
    'auth.strength_good': 'Bon',
    'auth.strength_strong': 'Fort',
    'auth.error_taken': 'Cet email est déjà utilise',
    'auth.error_invalid': 'Email ou mot de passe incorrect',
    'auth.error_unconfirmed': 'Email non confirmé. Vérifié ta boîte mail.',
    'auth.error_weak': 'Mot de passe trop faible',
    'auth.error_network': 'Erreur réseau. Reessaie.',

    // --- Onboarding (refonte) ---
    'onb.slide1_title': 'Bienvenue dans MIXALGO',
    ...
    'activation.locked_title': 'Ta boîte est verrouillee',
    'activation.locked_body': "Entre le code magique qui se trouve\ndans ta boîte MIXALGO pour l'ouvrir.",
    'activation.code_empty': 'Entre ton code pour ouvrir la boîte',
    'activation.cta_open': 'OUVRIR LA BOÎTE',
    'activation.cta_back_games': 'Retour à mes jeux',
    'activation.already_open_title': 'Ta boîte est déjà ouverte !',
    'activation.cta_continue': 'CONTINUER MON AVENTURE',
    'activation.cta_add_another': 'Activer une autre boîte',
    'activation.success_title': 'TA BOÎTE EST OUVERTE !',
    'activation.success_body': "Tu viens de débloquer un univers\nde cartes et de trios.",
    'activation.cta_start': "COMMENCER L'AVENTURE",

    // --- Level Map (refonte) ---
    'levelmap.title': 'Ta carte de quete',
    'levelmap.zone_d1': 'ZONE D1 · DÉCOUVERTE',
    ...
    'levelmap.unlock_hint': "Terminé d'abord le niveau {n}",

    // --- Profile (refonte, profile.title existe deja) ---
    'profile.section_trophies': 'TES TROPHEES',
    'profile.section_recent': 'DERNIÈRES PARTIES',
    'profile.section_account': 'PARAMÈTRES DU COMPTE',
    ...
    'result.level_passed': 'Niveau {n} validé',
    'result.level_retry': 'Niveau {n} à reprendre',
    ...
    'forgot.title_refonte': 'Mot de passe oublié',
    ...
    'forgot.error_network': 'Erreur réseau. Reessaie.',
    'forgot.cta_send': 'ENVOYER LE LIEN',
    // forgot.sent_title existe deja plus haut ("Email envoye")
    'forgot.sent_body': "Regarde dans ta boîte mail et clique\nsur le lien qu'on t'a envoyé.",
    ...
    'gallery.chip_locked': 'A découvrir',
    ...
    // --- Leaderboard (refonte) ---
    'lb.title': 'Classement',
    'lb.no_game_selected': 'Aucun jeu sélectionné',
    ...
    'qr.already_scanned': 'Carte déjà scannee',
    'qr.not_in_game': "Cette carte n'appartient pas à ce jeu",

    // --- Tutorial (refonte, tuto.title existe deja) ---
    'tuto.hero_title': 'Le trio magique',
    'tuto.hero_body': 'Chaque trio à 3 cartes qui vont ensemble.',
    'tuto.step1_title': 'Emettrice',
    'tuto.step1_body': "L'image de depart (un animal, un objet...).",
    'tuto.step2_title': 'Cable',
    'tuto.step2_body': "La transformation qui change l'Émettrice.",
    'tuto.step3_title': 'Receptrice',
    'tuto.step3_body': 'Le résultat final : Émettrice + Cable = Réceptrice.',
    ...
    'editpseudo.min': 'Minimum 2 caractères',
    'editpseudo.max': 'Maximum 20 caractères',
    'editpseudo.saved': 'Pseudo mis à jour',
    'editpseudo.error_net': 'Erreur réseau',
    'editpseudo.cta_save': "C'EST MON NOM",
    'editpseudo.cta_cancel': 'Annuler',

    // --- Help (refonte) ---
    'help.title_refonte': 'Aide',
    'help.hero_title': "Besoin d'aidé ?",
    'help.hero_body': "Trouve les réponses a tes questions\nou relis le tutoriel.",
    'help.section_gameplay': 'LE JEU',
    'help.section_account': 'MON COMPTE',
    'help.section_physical': 'LA BOÎTE MIXALGO',
    ...
    'tour.step1_body': "Le bouton JOUER au milieu te fait démarrer la partie\nde ton niveau actuel.",
