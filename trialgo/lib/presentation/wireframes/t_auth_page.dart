              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Espacement vertical avant la bascule login/signup.
                    // Remplace l'ancien bloc Google OAuth (non configure) :
                    // le separateur "ou" + le bouton "Continuer avec Google"
                    // ont ete retires tant que l'OAuth Google n'est pas cable.
                    // Cela evite d'afficher un bouton non fonctionnel a
                    // l'utilisateur (UX : pas de fausse promesse).
                    const SizedBox(height: 18),

                    // --- Lien "Mot de passe oublie ?" ---
                    // Affiche uniquement en mode login : ca n'a pas de
                    // sens lors de l'inscription (pas encore de compte).
                    // Navigue vers TForgotPasswordPage qui demande l'email
                    // et declenche l'envoi du lien de reset par Supabase.
                    if (_isLogin)
                      Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: Text(
                            ...
                            style: const TextStyle(
                              ...
                              // decoration underline pour signaler
                              // visuellement qu'il s'agit d'un lien.
