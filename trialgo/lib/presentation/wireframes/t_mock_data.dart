...
class MockData {
  ...
  static const List<Map<String, dynamic>> mockLevels = [
    ...
    {'level': 5,  'unlocked': true,  'completed': true,  'stars': 2, 'label': 'Double défi',    'distance': 'D1', 'configs': 'A+B'},
    ...
    {'level': 8,  'unlocked': false, 'completed': false, 'stars': 0, 'label': 'Chaînes',        'distance': 'D2', 'configs': 'A+B'},
